...
return (
    <div className="employer_CreateProfile-container">
      ...
      <span><img src={profileIcon} alt="profileIcon" class="employer_CreateProfile-Upload-profileIcon" />My Profile
              </span>
      </a>
    </nav>
  </header>
  ...
  <main class="employer_CreateProfile-middle-container">
    <section class="employer_CreateProfile-profile-header">
      ...
      <p>Start your journey towards the right job. Fill in your details so employers can find you easily.</p>
      <div class="employer_CreateProfile-progress-bar">
        ...
        <div class="employer_CreateProfile-step">
          ...
          <span class="employer_CreateProfile-step-text">Recruiter Info</span>
        </div>
      </div>
    </section>
    ...
    <div class="employer_CreateProfile-card-company-info-section">
      <div class="employer_CreateProfile-card-header">
        <span><img src={companyBuilding} alt="companyBuilding" class="employer_CreateProfile-companyBuilding" />
              </span>
      ...
      <div class="employer_CreateProfile-card-body">
        <div class="employer_CreateProfile-company-logo-upload">
          <span><img src={UploadCompanyImage} alt="UploadCompanyProfile" class="employer_CreateProfile-UploadCompanyProfile-image" />
              </span>

              <span><img src={camera} alt="Camera" class="employer_CreateProfile-Upload-Camera-image" />
              </span>
        </div>

        <div class="employer_CreateProfile-form-row">
          <div class="employer_CreateProfile-form-group full-width">
            <label for="employer_CreateProfile-companyName">Company Name</label>
        ...
        <div class="employer_CreateProfile-form-row">
          <div class="employer_CreateProfile-form-group-half-width">
            ...
            <input type="email" id="emailAddress" placeholder="Enter your Email-ID" />
          </div>
          <div class="employer_CreateProfile-form-group-half-width">
            <label for="website">Website</label>
            <input type="url" id="website" placeholder="Enter company's website URL" />
          </div>
        </div>
        ...
        <div class="employer_CreateProfile-form-row">
          <div class="employer_CreateProfile-form-group-full-width">
            ...
            <div class="employer_CreateProfile-location-inputs">
              ...
              <select><option value="">Select your state <span>
                <img src={vector} alt="vector" class="employer_CreateProfile-vector" />
              </span></option></select>
              <select><option value="">Select your country</option></select>
            </div>
          </div>
        </div>
        ...
        <div class="employer_CreateProfile-form-row">
          <a href="#" class="employer_CreateProfile-add-location">
            <span>
                <img src={plusIcon} alt="plusIcon"/>Add another location
              </span> 
          </a>
        </div>
        ...
        <div class="employer_CreateProfile-form-row">
          <div class="employer_CreateProfile-form-group-full-width">
            <label for="employer_CreateProfile-aboutCompany">About company</label>
            <textarea
              id="aboutCompany"
              rows="5"
    ...
    <section class="employer_CreateProfile-card-recruiter-info-section">
      <div class="employer_CreateProfile-card-header">
        <img src={user} alt="User" class="icon-img" style={{ color: '842cc0' }}/>
      ...
      <div class="employer_CreateProfile-card-body">
        <div class="employer_CreateProfile-form-row">
          <div class="employer_CreateProfile-form-group full-width">
            ...
            <input type="text" id="recruiterName" placeholder="Enter your full name" />
          </div>
        </div>
        <div class="employer_CreateProfile-form-row">
          <div class="employer_CreateProfile-form-group-half-width">
            <label for="recruiterEmail">Email Address</label>
            <input type="email" id="recruiterEmail" placeholder="Enter your Email-ID" />
          </div>
          <div class="employer_CreateProfile-form-group-half-width">
...
<div class="employer_CreateProfile-form-row">
          <div class="employer_CreateProfile-form-group-half-width">
          <button class="employer_CreateProfile-btn-secondary">Save as draft</button>
          </div>
          <div class="employer_CreateProfile-form-group-half-width">
          <button 
    ...
    <footer className="employer_CreateProfile-footer">
        ...
        <p className="employer_CreateProfile-footer-note">@2025 AccureSofTech. All rights reserved</p>
